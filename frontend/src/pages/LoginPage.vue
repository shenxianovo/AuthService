  ...
  <div>
    <Tabs default-value="signin" class="mb-6">
      <TabsList class="w-full">
        ...
        <TabsTrigger value="signup" class="flex-1" @click="$router.push('/register')">Sign up</TabsTrigger>
      </TabsList>
    </Tabs>
    ...
    <div class="mt-3 text-right text-sm">
      <router-link to="/forgot-password" class="text-muted-foreground hover:text-foreground hover:underline">Forgot password?</router-link>
    </div>
